  ...
  const [formData, setFormData] = useState({
    ...
    duration:
      (new Date(
        ...
        (new Date(`${data.departure_date.split("T")[0]}T${data.arrival_time}`) <
        new Date(`${data.departure_date.split("T")[0]}T${data.departure_time}`)
          ? 86400000
          : 0) -
        new Date(
      ...
      <div className={styles.form}>
          ...
          >
            <button
              className={`${styles.dropdownButton} ${
                formData.airline ? styles.airlineButton : ""
              }`}
            ...
            >
              ...
              {formData.airline ? (
                <X
                  size={20}
                  onClick={(e) => clearSelection("airline", e)}
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        selectOption("airline", route.flight_route);
                      }}
                    >
                      {route.flight_route}
                    </div>
        ...
        <div className={styles.row}>
          ...
          >
            <button
              className={`${styles.dropdownButton} ${
                formData.departure ? styles.airlineButton : ""
              }`}
            ...
            >
              ...
              {formData.departure ? (
                <X
                  size={20}
                  onClick={(e) => clearSelection("departure", e)}
                  className={styles.clearIcon}
                />
              ) : (
                <Plane className={styles.inputIcon} size={20} />
          ...
          >
            <button
              className={`${styles.dropdownButton} ${
                formData.destination ? styles.airlineButton : ""
              }`}
            ...
            >
              ...
              {formData.destination ? (
                <X
                  size={20}
                  onClick={(e) => clearSelection("destination", e)}
                  className={styles.clearIcon}
                />
              ) : (
                <Plane className={styles.inputIcon} size={20} />
        ...
        <div className={styles.tableContainer}>
          <div className={styles.tableHeader}>
            ...
            <div className={styles.tableHeaderCell}>Số lượng vé</div>
            <div className={styles.tableHeaderCell}>Thao tác</div>
          </div>

          {formData.seatClasses?.map((seatClass, index) => (
            <div key={index} className={styles.tableRow}>
              <div className={styles.tableCell}>{seatClass.class}</div>
              <div className={styles.tableCell}>{seatClass.quantity}</div>
              <div className={styles.tableCell}>
                <button
                  ...
                  onClick={() => {
                    setFormData((prev) => ({
                      ...prev,
                      seatClasses: prev.seatClasses.filter(
                        (_, i) => i !== index
                      ),
                    }));
                  }}
          ...
          <div className={styles.tableRow}>
            <div className={styles.tableCell}>
              <div
                className={styles.dropdown}
                ref={(el) => (dropdownRefs.current.seatClass = el)}
                style={{
                  zIndex: dropdowns.seatClass ? 2500 : 1000,
                }}
              >
                <button
                  className={`${styles.ticketClass} ${
                    newSeatClass.class ? styles.airlineButton : ""
                  }`}
            ...
            <div className={styles.tableCell}>
              <button
                ...
                onClick={() => {
                  if (newSeatClass.class && newSeatClass.quantity) {
                    setFormData((prev) => ({
                      ...prev,
                      seatClasses: [...prev.seatClasses, newSeatClass],
                    }));
                    setNewSeatClass({
                      class: "",
                      quantity: "",
