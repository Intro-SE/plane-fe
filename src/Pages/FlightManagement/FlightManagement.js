        ...
        <div className={styles["content-container"]}>
          ...
          <div className={styles.container}>
            <div className={styles.header}>
              <h1 className={styles.title}>
                ...
                <span className={styles["flight-count"]}>{flights.length}</span>
              </h1>
              ...
              <div className={styles.actions}>
                ...
                <button
                  ...
                  className={`${styles.button} ${
                    selectedFlights.length > 0 ? styles["delete-active"] : ""
                  }`}
                >
          ...
          {isAddFlightFormOpen && (
            <div className={styles.overlay}>
              <div className={styles.modal}>
                <AddFlightForm
                  onClose={() => setIsAddFlightFormOpen(false)}
                  routeData={routeData}
          ...
          {isUpdateFlightFormOpen && (
            <div className={styles.overlay}>
              <div className={styles.modal}>
                <FixFlightForm
                  onClose={() => setIsUpdateFlightFormOpen(false)}
                  routeData={routeData}
                  seatClassData={seatClassData}
